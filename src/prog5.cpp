...
int main()
{
    ...
    Shader objShader(find_executable().parent_path().append("../../src/shader/vertex/prog5.vertex.vs").string().c_str(), find_executable().parent_path().append("../../src/shader/fragment/prog5.fragment.fs").string().c_str());
    ...
    Texture2D emissionTex = Texture2D(find_executable().parent_path().append("../../res/textures/matrix.jpg").string().c_str());
    ...
    glBindTexture(GL_TEXTURE_2D, emissionTex.Texture);
